...
public class ChoicePanel {
	...
	private VPanel vp = new VPanel(0, 35, widthReference, heightReference,
	...
	public ChoicePanel(Play play) {
		...
		for (int i = 0; i < choices.length; i++) {
			choices[i] = new ChoiceButton(widthReference/4*(i+1)-buttonW/2,
										  heightReference/2-buttonH/2, buttonW,
										  buttonH, widthReference, heightReference/*, play*/);
	...
	public void display(Graphics2D g2d) {
		if (percentOnScreen > 0) {
			...
			UsefulTh.drawString(text, play.playP.getWidth()/2-textW/2,
								(int)(60*play.scaleW)+textH/2, g2d);
